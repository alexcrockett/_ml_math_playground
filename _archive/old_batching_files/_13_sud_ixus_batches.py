...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'ixus_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	ixus_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	ixus_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	ixus_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	ixus_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	ixus_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	ixus_list = [ixus_batch_1, ixus_batch_2, ixus_batch_3, ixus_batch_4, ixus_batch_5]
	# Print the first batch for demonstration
	# print(ixus_batch_1.head())
	return ixus_list
