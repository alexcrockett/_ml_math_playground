...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'kre_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	kre_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	kre_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	kre_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	kre_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	kre_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	kre_list = [kre_batch_1, kre_batch_2, kre_batch_3, kre_batch_4, kre_batch_5]
	# Print the first batch for demonstration
	# print(kre_batch_1.head())
	return kre_list
