...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'lit_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	lit_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	lit_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	lit_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	lit_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	lit_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	lit_list = [lit_batch_1, lit_batch_2, lit_batch_3, lit_batch_4, lit_batch_5]
	# Print the first batch for demonstration
	# print(lit_batch_1.head())
	return lit_list
