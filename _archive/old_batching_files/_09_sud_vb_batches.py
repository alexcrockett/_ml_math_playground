...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'vb_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	vb_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	vb_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	vb_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	vb_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	vb_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	vb_list = [vb_batch_1, vb_batch_2, vb_batch_3, vb_batch_4, vb_batch_5]
	# Print the first batch for demonstration
	# print(vb_batch_1.head())
	return vb_list
