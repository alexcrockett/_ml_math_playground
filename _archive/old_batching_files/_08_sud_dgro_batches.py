...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'dgro_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	dgro_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	dgro_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	dgro_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	dgro_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	dgro_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	dgro_list = [dgro_batch_1, dgro_batch_2, dgro_batch_3, dgro_batch_4, dgro_batch_5]
	# Print the first batch for demonstration
	# print(dgro_batch_1.head())
	return dgro_list
