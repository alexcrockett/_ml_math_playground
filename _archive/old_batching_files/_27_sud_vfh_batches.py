...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'vfh_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	vfh_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	vfh_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	vfh_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	vfh_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	vfh_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	vfh_list = [vfh_batch_1, vfh_batch_2, vfh_batch_3, vfh_batch_4, vfh_batch_5]
	# Print the first batch for demonstration
	# print(vfh_batch_1.head())
	return vfh_list
