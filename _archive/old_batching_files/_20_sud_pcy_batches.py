...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'pcy_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	pcy_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	pcy_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	pcy_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	pcy_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	pcy_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	pcy_list = [pcy_batch_1, pcy_batch_2, pcy_batch_3, pcy_batch_4, pcy_batch_5]
	# Print the first batch for demonstration
	# print(pcy_batch_1.head())
	return pcy_list
