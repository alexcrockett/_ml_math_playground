...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'schd_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	schd_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	schd_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	schd_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	schd_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	schd_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	schd_list = [schd_batch_1, schd_batch_2, schd_batch_3, schd_batch_4, schd_batch_5]
	# Print the first batch for demonstration
	# print(schd_batch_1.head())
	return schd_list
