...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'pey_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	pey_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	pey_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	pey_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	pey_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	pey_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	pey_list = [pey_batch_1, pey_batch_2, pey_batch_3, pey_batch_4, pey_batch_5]
	# Print the first batch for demonstration
	#print(pey_batch_1.head())
	return pey_list
