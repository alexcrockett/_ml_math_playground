...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'iscf_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	iscf_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	iscf_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	iscf_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	iscf_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	iscf_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	iscf_list = [iscf_batch_1, iscf_batch_2, iscf_batch_3, iscf_batch_4, iscf_batch_5]
	# Print the first batch for demonstration
	# print(iscf_batch_1.head())
	return iscf_list
