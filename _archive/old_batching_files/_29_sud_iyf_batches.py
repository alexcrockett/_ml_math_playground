...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'iyf_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	iyf_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	iyf_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	iyf_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	iyf_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	iyf_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	iyf_list = [iyf_batch_1, iyf_batch_2, iyf_batch_3, iyf_batch_4, iyf_batch_5]
	# Print the first batch for demonstration
	# print(iyf_batch_1.head())
	return iyf_list
