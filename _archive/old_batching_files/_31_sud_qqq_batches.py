...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'qqq_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	qqq_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	qqq_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	qqq_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	qqq_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	qqq_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	qqq_list = [qqq_batch_1, qqq_batch_2, qqq_batch_3, qqq_batch_4, qqq_batch_5]
	# Print the first batch for demonstration
	# print(qqq_batch_1.head())
	return qqq_list
