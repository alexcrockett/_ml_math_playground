...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'xlk_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	xlk_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	xlk_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	xlk_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	xlk_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	xlk_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	xlk_list = [xlk_batch_1, xlk_batch_2, xlk_batch_3, xlk_batch_4, xlk_batch_5]
	# Print the first batch for demonstration
	# print(xlk_batch_1.head())
	return xlk_list
