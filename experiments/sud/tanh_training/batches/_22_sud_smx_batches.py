...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'smx_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	smx_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	smx_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	smx_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	smx_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	smx_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	smx_list = [smx_batch_1, smx_batch_2, smx_batch_3, smx_batch_4, smx_batch_5]
	# Print the first batch for demonstration
	# print(smx_batch_1.head())
	return smx_list
