...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'xle_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	xle_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	xle_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	xle_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	xle_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	xle_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	xle_list = [xle_batch_1, xle_batch_2, xle_batch_3, xle_batch_4, xle_batch_5]
	# Print the first batch for demonstration
	# print(xle_batch_1.head())
	return xle_list
