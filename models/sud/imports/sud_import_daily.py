...
# We will need to identify the stocks and iterate through them to build our data set
# This is a list of ETFs that we will treat as the stock tickers we will use for data
