...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'xly_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	xly_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	xly_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	xly_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	xly_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	xly_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	xly_list = [xly_batch_1, xly_batch_2, xly_batch_3, xly_batch_4, xly_batch_5]
	# Print the first batch for demonstration
	# print(xly_batch_1.head())
	return xly_list
