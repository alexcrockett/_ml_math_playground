...
def get_batches(stock_symbol):
	...
	for i, batch in enumerate(batch_stock):
		...
		batch_dataframes[f'vym_batch_{i+1}'] = stock_batches  # Store in dictionary
...
def main():
	...
	vym_batch_1 = batch_dataframes[f'{stock_symbol.lower()}_batch_1']
	vym_batch_2 = batch_dataframes[f'{stock_symbol.lower()}_batch_2']
	vym_batch_3 = batch_dataframes[f'{stock_symbol.lower()}_batch_3']
	vym_batch_4 = batch_dataframes[f'{stock_symbol.lower()}_batch_4']
	vym_batch_5 = batch_dataframes[f'{stock_symbol.lower()}_batch_5']
	vym_list = [vym_batch_1, vym_batch_2, vym_batch_3, vym_batch_4, vym_batch_5]
	# Print the first batch for demonstration
	# print(vym_batch_1.head())
	return vym_list
